...
class CssLanguage(controller: EditorController) : BaseLanguage(controller) {

    private val autoCompleteHelper = CssAutoCompleteHelper()

    override val mAutoCompleteItem: MutableList<AutoCompleteItem> = ArrayList()

    override val mLexer: CssLexer = CssLexer()
