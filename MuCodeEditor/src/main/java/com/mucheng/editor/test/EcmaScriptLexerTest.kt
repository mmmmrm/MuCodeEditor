...
fun main() {
    ...
    val bufferWriter = File("D:\\AndroidProjects\\MuCodeEditorExample\\QuickCodeEditor\\src\\main\\java\\com\\mucheng\\editor\\test\\output.txt").bufferedWriter()
...
fun getContent() =
    File("D:\\AndroidProjects\\MuCodeEditorExample\\QuickCodeEditor\\src\\main\\java\\com\\mucheng\\editor\\test\\test.js").bufferedReader()
        .readText().split("\r\n").toList()